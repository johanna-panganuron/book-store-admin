              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50/50">
                    ...
                    <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide w-48">
                      <div className="flex items-center gap-1.5"><Settings className="w-4 h-4 text-gray-400" /> Actions</div>
                    </th>
                  </tr>
                </thead>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="h-8 text-xs px-3 flex items-center gap-1.5 rounded-lg border border-emerald-200 text-emerald-700 bg-emerald-50/50 hover:bg-emerald-100 transition-colors"
                          >
                          ...
                          {canViewCostPrice && (
                            <button
                              ...
                              className="h-8 text-xs px-3 flex items-center gap-1.5 rounded-lg border border-amber-200 text-amber-700 bg-amber-50/50 hover:bg-amber-100 transition-colors whitespace-nowrap"
                            >
